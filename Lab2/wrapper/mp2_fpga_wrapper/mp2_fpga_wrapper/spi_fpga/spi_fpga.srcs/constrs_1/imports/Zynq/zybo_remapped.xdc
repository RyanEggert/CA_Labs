...
## I've renamed most of the PMODs to follow a consistent naming scheme.
##
##  [3v3][gnd][3][2][1][0]
##  [3v3][gnd][7][6][5][4]
##
## This is how the signals are mapped on the PMOD if you're staring
## into the port from the front.
...
##Pmod Header JB
##IO_L15N_T2_DQS_34
#set_property PACKAGE_PIN U20 [get_ports {jb[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[1]}]

##IO_L15P_T2_DQS_34
#set_property PACKAGE_PIN T20 [get_ports {jb[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[0]}]

##IO_L16N_T2_34
#set_property PACKAGE_PIN W20 [get_ports {jb[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[3]}]

##IO_L16P_T2_34
#set_property PACKAGE_PIN V20 [get_ports {jb[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[2]}]

##IO_L17N_T2_34
#set_property PACKAGE_PIN Y19 [get_ports {jb[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[5]}]

##IO_L17P_T2_34
#set_property PACKAGE_PIN Y18 [get_ports {jb[4]}]
...
##IO_L1N_T0_34
#set_property PACKAGE_PIN T10 [get_ports {jc[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[3]}]

##IO_L1P_T0_34
#set_property PACKAGE_PIN T11 [get_ports {jc[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[2]}]

##IO_L8N_T1_34
#set_property PACKAGE_PIN Y14 [get_ports {jc[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[5]}]

##IO_L8P_T1_34
#set_property PACKAGE_PIN W14 [get_ports {jc[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[4]}]

##IO_L2N_T0_34
#set_property PACKAGE_PIN U12 [get_ports {jc[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[7]}]

##IO_L2P_T0_34
#set_property PACKAGE_PIN T12 [get_ports {jc[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[6]}]

##Pmod Header JD
##IO_L5N_T0_34
#set_property PACKAGE_PIN T15 [get_ports {jd[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[1]}]

##IO_L5P_T0_34
#set_property PACKAGE_PIN T14 [get_ports {jd[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[0]}]

##IO_L6N_T0_VREF_34
#set_property PACKAGE_PIN R14 [get_ports {jd[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[3]}]

##IO_L6P_T0_34
#set_property PACKAGE_PIN P14 [get_ports {jd[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[2]}]

##IO_L11N_T1_SRCC_34
#set_property PACKAGE_PIN U15 [get_ports {jd[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[5]}]

##IO_L11P_T1_SRCC_34
#set_property PACKAGE_PIN U14 [get_ports {jd[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[4]}]

##IO_L21N_T3_DQS_34
#set_property PACKAGE_PIN V18 [get_ports {jd[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[7]}]

##IO_L21P_T3_DQS_34
#set_property PACKAGE_PIN V17 [get_ports {jd[6]}]
